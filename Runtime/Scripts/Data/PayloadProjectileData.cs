...
namespace GreedyVox.NetCode.Data
{
    ...
    /// </summary>
    [RequireComponent(typeof(NetCodeProjectile))]
    public class PayloadProjectileData : PayloadAbstract
    {
        /// <summary>
        /// Receives authoritative payload data and dispatches it locally.
        /// </summary>
        [Rpc(SendTo.SpecifiedInParams)]
        protected void PongRpc(PayloadProjectile data, RpcParams rpc) => m_Payload?.Payload(data);
        /// <summary>
        ...
        protected override void PingRpc(RpcParams rpc = default)
        {
            ...
            && data is PayloadProjectile projectile)
